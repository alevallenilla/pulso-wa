...
const BeforePhone = () => (
  <div className="w-[280px] md:w-[300px] rounded-[2rem] border-[3px] border-[hsl(216,30%,20%)] bg-[#111b21] shadow-2xl overflow-hidden flex-1 flex flex-col">
    ...
    <div className="flex items-center gap-2 px-3 py-2 bg-[#1f2c34]">
      ...
      <span className="text-sm font-semibold text-[#e9edef]">Taquería El Güero</span>
    </div>
    <div className="px-3 py-3 space-y-2 flex-1" style={{ background: '#0b141a' }}>
      ...
      <div className="flex justify-end">
        <div className="max-w-[80%] bg-[#005c4b] rounded-lg rounded-tr-sm px-2.5 py-1.5">
          <p className="text-[12px] text-[#e9edef]">Hola! What's on the menu? 🌮</p>
          <span className="text-[10px] text-[#8696a0] float-right ml-2 mt-0.5">10:29</span>
        </div>
      </div>
      <div className="flex justify-start">
        <div className="max-w-[80%] bg-[#202c33] rounded-lg rounded-tl-sm px-2.5 py-1.5">
          <p className="text-[12px] text-[#e9edef]">Tacos, burritos, tortas... quieres la lista? 😅</p>
          <span className="text-[10px] text-[#8696a0] float-right ml-2 mt-0.5">10:34</span>
        </div>
      </div>
      <div className="flex justify-end">
        <div className="max-w-[80%] bg-[#005c4b] rounded-lg rounded-tr-sm px-2.5 py-1.5">
          <p className="text-[12px] text-[#e9edef]">2 al pastor please, how much?</p>
          <span className="text-[10px] text-[#8696a0] float-right ml-2 mt-0.5">10:41</span>
        </div>
      </div>
      <div className="flex justify-start">
        <div className="max-w-[80%] bg-[#202c33] rounded-lg rounded-tl-sm px-2.5 py-1.5">
          <p className="text-[12px] text-[#e9edef]">Wait which order is this? 🤔</p>
          <span className="text-[10px] text-[#8696a0] float-right ml-2 mt-0.5">10:52</span>
        </div>
      </div>
    </div>
...
const AfterPhone = () => (
  <div className="w-[280px] md:w-[300px] rounded-[2rem] border-[3px] border-[hsl(216,30%,20%)] bg-[#111b21] shadow-2xl overflow-hidden flex-1 flex flex-col">
    ...
    <div className="px-3 py-3 space-y-2 flex-1" style={{ background: '#0b141a' }}>
      ...
      <div className="flex justify-end">
        <div className="max-w-[80%] bg-[#005c4b] rounded-lg rounded-tr-sm px-2.5 py-1.5">
          <p className="text-[12px] text-[#e9edef]">Hola! 👋</p>
      ...
      <div className="flex justify-start">
        <div className="max-w-[92%] bg-[#202c33] rounded-lg rounded-tl-sm px-2.5 py-2">
          <p className="text-[12px] text-[#e9edef] mb-1.5">Welcome! What would you like? 🌮</p>
          <div className="space-y-1">
            {["Tacos Al Pastor · $7", "Burrito Carnitas · $10"].map((item) => (
              <div key={item} className="bg-[#25d366]/10 border border-[#25d366]/20 rounded px-2 py-1 text-[10px] text-[#25d366]">{item}</div>
            ))}
          </div>
        ...
        <div className="max-w-[90%] bg-[#202c33] rounded-lg rounded-tl-sm px-2.5 py-2">
          <div className="bg-[#111b21] rounded-lg border border-[#2a3942] overflow-hidden mb-1">
            <div className="bg-[#25d366]/10 px-3 py-2 flex items-center gap-2">
              ...
              <span className="text-[13px] font-semibold text-[#25d366]">Order confirmed</span>
            </div>
            <div className="px-3 py-2 space-y-1">
              <div className="flex justify-between items-baseline">
                <span className="text-[10px] text-[#8696a0]">2× Tacos Al Pastor</span>
                <span className="text-sm font-bold text-[#e9edef]">$14.00</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[10px] text-[#8696a0]">Ref</span>
                <span className="text-[10px] text-[#8696a0] font-mono">ORD-4K82X</span>
              </div>
            </div>
          </div>
          <span className="text-[10px] text-[#8696a0] float-right ml-2">10:32</span>
        </div>
      </div>
    </div>
    <div className="flex items-center gap-2 px-2 py-2 bg-[#111b21]">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground">
            530 million people in Latin America run their businesses, take orders, and collect payments over WhatsApp every day. But they're doing it manually — no structure, no automation, no way to scale. Pulso is the missing infrastructure layer.
          </p>
        </motion.div>
        ...
        >
          <div className="flex flex-col items-center gap-3">
            <span className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Without Pulso</span>
            <BeforePhone />
          </div>
          <div className="flex flex-col items-center gap-3">
            <span className="text-xs font-semibold uppercase tracking-wider text-[#25d366]">With Pulso Order</span>
            <AfterPhone />
          </div>
        </motion.div>
      </div>
